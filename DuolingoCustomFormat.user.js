...
function main() {
	...
	var textareaCheck = function(obj) {
		var summary = obj[0];
		summary.added.forEach(function(ta) {
			var textarea = $(ta);
			if ((typeof textarea != 'undefined') && (textarea !== null)) {
				if ($(textarea).placeholder == "Escribe en inglés") {
				    var targetElement = $(textarea); //.find(".emojitext.ellipsify").first();
				    manipulateTargetElement(targetElement, "blue");
				}
			}
		});
	};
...
function manipulateTargetElement(targetElement, color)
{
